 ...
 * - [Application] 启动会自动注册 参见 [.InitContentProvider]
 *
 */
@Suppress("unused")
object AppManager {
    ...
    private val mActivityLifecycleCallbacks = object : Application.ActivityLifecycleCallbacks {
        ...
        override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
            onCreate(activity)
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityCreated")
        }

        override fun onActivitySaveInstanceState(activity: Activity, outState: Bundle) {
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivitySaveInstanceState")
        }
        ...
        override fun onActivityStarted(activity: Activity) {
            ...
            foregroundCount++
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityStarted")
        }

        override fun onActivityResumed(activity: Activity) {
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityResumed")
        }

        override fun onActivityPaused(activity: Activity) {
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityPaused")
        }
        ...
        override fun onActivityStopped(activity: Activity) {
            ...
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityStopped")
        }

        override fun onActivityDestroyed(activity: Activity) {
            onDestroy(activity)
            AppLog.i("Activity: ${activity.javaClass.simpleName} ----> onActivityDestroyed")
        }
    }
    ...
    private fun getApplicationByReflect(): Application {
        try {
            ...
            AppLog.e(e, "getApplicationByReflect")
        }
        throw NullPointerException("u should init first")
    }
